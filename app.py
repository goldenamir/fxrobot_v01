...
# timezone list
timezone = ['America/New_York', 'Europe/London', 'Europe/Paris', 'Asia/Tokyo', 'Australia/Sydney']
...
print(get_quotes(time_frame=time_frame['frame_H4'], year=2023, month=8, day=25))
